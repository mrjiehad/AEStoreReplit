      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div data-testid="footer-company-info">
            <h3 className="text-2xl font-bebas text-neon-yellow mb-4 uppercase tracking-wider">AECOIN STORE</h3>
          ...
          <div data-testid="footer-quick-links">
            <h3 className="text-xl font-bebas text-neon-yellow mb-4 uppercase tracking-wider">Quick Links</h3>
          ...
          <div data-testid="footer-info-links">
            <h3 className="text-xl font-bebas text-neon-yellow mb-4 uppercase tracking-wider">Information</h3>
            <ul className="space-y-2">
              <li>
                <a href="#" className="text-muted-foreground hover:text-neon-yellow transition-colors">
                  Whitelist
        ...
        <div className="border-t border-border pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex items-center gap-4">
              ...
              <Button
                className="bg-neon-yellow hover:bg-neon-yellow hover:scale-105 text-black font-bold uppercase text-xs h-9 px-6 rounded-sm transition-transform font-rajdhani tracking-wide"
